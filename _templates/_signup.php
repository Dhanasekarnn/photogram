<?php 
$signup = false;
if(isset($_POST['username']) and isset($_POST['phone']) and isset($_POST['email_address']) and isset($_POST['password'])){
...
<? if($signup){
    ...
    <p class="lead">now you <a href="/login.php">here</a>.</p>
    </div>
 </main>
      <?
    }
    ...
    <main
     <div class="bg-body-tertiary p-5 rounded mt-3">
    <h1>siignup fail</h1>
    <p class="lead">now you rong,<?=$error?><a href="/login.php">here</a>.</p>
  </div>
 </main>
  <? }
} else{
